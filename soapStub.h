...
/* complex XSD type 'ns:hello': */
struct SOAP_CMAC ns__hello {
      public:
        /** Required element 'input' of XSD type 'xsd:double' */
        double input;
      public:
